                ...
                <div class="shopping-cart-table ">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th class="cart-romove item">Xoa</th>
                                    <th class="cart-description item">Hinh anh</th>
                                    <th class="cart-product-name item">Ten san pham</th>
                                    <th class="cart-qty item">So luong</th>
                                    <th class="cart-sub-total item">Don gia</th>
                                </tr>
                            </thead><!-- /thead -->
                                ...
                                <tr >
                                    <th>
                                        ...
                                        <div class="cart-grand-total" id="totalCart">
                                            Tong tien<span class="inner-left-md">${totalMoney.total} VND</span>
                                        </div>
                                    </th>
                                </tr>
                            </thead><!-- /thead -->
                                ...
                                <tr>
                                    <td>
                                        <div class="cart-checkout-btn pull-right">
                                            <button type="submit" onclick="pay(${pageContext.session.getAttribute("currentUser").id})" class="btn btn-primary checkout-btn">Thanh toan</button>
