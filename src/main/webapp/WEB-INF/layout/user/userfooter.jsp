<%-- 
    Document   : userfooter
    Created on : Sep 23, 2022, 3:50:16 PM
    Author     : Admin
--%>
        ...
        <div class="row">
              ...
              <div class="module-body">
                <ul class="toggle-footer" style="">
                  ...
                  <li class="media">
                    ...
                    <div class="media-body"> <span><a href="#">tinas15102016@gmail.com</a></span> </div>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="module-heading">
              <h4 class="module-title">Chăm sóc khách hàng</h4>
            </div>
            <!-- /.module-heading -->
            ...
            <div class="module-body">
              <ul class='list-unstyled'>
                ...
                <li><a href="#" title="About us">Lịch sử mua sắm</a></li>
                <li><a href="#" title="faq">FAQ</a></li>
                <li><a href="#" title="Popular Searches">Đặc biệt</a></li>
                <li class="last"><a href="#" title="Where is my order?">Hỗ trợ</a></li>
              </ul>
            </div>
            <!-- /.module-body -->
          </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <div class="module-body">
              <ul class='list-unstyled'>
                ...
                <li><a title="Information" href="#">Chăm sóc khách hàng</a></li>
      ...
      <div class="container">
        <div class="col-xs-12 col-sm-4 no-padding social">
          ...
          <div class="clearfix payment-methods">
            <ul>
              <li><img src="<c:url value="/user/assets/images/payments/1.png"/>" alt=""></li>
              <li><img src="<c:url value="/user/assets/images/payments/2.png"/>" alt=""></li>
              <li><img src="<c:url value="/user/assets/images/payments/3.png"/>" alt=""></li>
              <li><img src="<c:url value="/user/assets/images/payments/4.png"/>" alt=""></li>
              <li><img src="<c:url value="/user/assets/images/payments/5.png"/>" alt=""></li>
            </ul>
          </div>
          <!-- /.payment-methods -->
        </div>
